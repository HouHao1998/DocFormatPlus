...
public class StartMain {
    public static void main(String[] args) {
        String excelFilePath = "/Users/houhao/Downloads/徐泽13号报表/绕行访问涉敏后台资源审计.xlsx";  // Excel文件路径
        String jsonFilePath = "/Users/houhao/Downloads/徐泽13号报表/report_templates.json";  // JSON文件路径
        String sqlFilePath = "/Users/houhao/Downloads/徐泽13号报表/settingsDataSource.txt";  // SQL脚本文件路径
        String folderPath = "/Users/houhao/Downloads/徐泽13号报表/";
        ...
        String outputFolder = "/Users/houhao/Downloads/徐泽13号报表/上海报表测试文件夹/"; // 输出 Excel 文件夹路径
        //
        ExcelReportGenerator.makeExcel(jsonFilePath, outputFolder);
        long fileSn = 5012342106810301L;
        String minIo = "/Users/houhao/Downloads/徐泽13号报表/minIo.txt";
        ...
        long templateSn = 80123419117101001L;  // 初始SN值
        String templateFilePath = "/Users/houhao/Downloads/徐泽13号报表/report_template.txt";  // SQL文件路径
        ...
        long templateConfigSn = 80123419181190001L;  // 初始SN值
        String reportTemplateConfigFilePath = "/Users/houhao/Downloads/徐泽13号报表/report_template_config.txt";
        ExcelToTemplateConfig.excelToTemplateConfig(reportTemplateConfigFilePath, jsonFilePath);
        // long taskSn = 80042409112820011L;
        // String outputFilePath = "/Users/houhao/Downloads/徐泽13号报表/report_task.txt";  // SQL 文件输出路径
        //
        // ExcelToTask.jsonToTask(jsonFilePath, outputFilePath, taskSn);
        String[] txtFiles = {
                "/Users/houhao/Downloads/徐泽13号报表/settingsDataSource.txt",
                "/Users/houhao/Downloads/徐泽13号报表/minIo.txt",
                "/Users/houhao/Downloads/徐泽13号报表/report_template.txt",
                "/Users/houhao/Downloads/徐泽13号报表/report_template_config.txt"
        };

        // 合并后的输出文件
        String outputFilePath = "/Users/houhao/Downloads/徐泽13号报表/统一执行sql文件.txt";
